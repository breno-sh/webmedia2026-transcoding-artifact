#!/usr/bin/env python3
"""
Phase 3.2 — Horizontal Scaling: 10× c5.large processing 10-min video (1 min each).
"""
...
PRESET = "slow"
NUM_PARTS = 10
MAX_WORKERS = 5  # 5 instances × 2 vCPUs = 10 vCPUs

PARTS_DIR = "./artifact/artifacts2/phase3_scaling/video_parts_c5"
COMPRESSED_DIR = "./artifact/artifacts2/phase3_scaling/compressed_parts_c5"
...
def split_video():
    ...
    if not os.path.exists(INPUT_VIDEO):
        log(f"ERROR: Video not found: {INPUT_VIDEO}", "Setup")
        return False
...
if __name__ == "__main__":
    ...
    with open("c5_large_horizontal.log", "w") as logfile:
