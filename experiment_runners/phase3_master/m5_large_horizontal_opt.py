#!/usr/bin/env python3
"""
Phase 3.2 OPTIMIZED — Horizontal: 10× m5.large with custom AMI (ffmpeg pre-installed).
"""
...
PARTS_DIR = "./artifact/artifacts2/phase3_scaling/video_parts_m5_opt"
COMPRESSED_DIR = "./artifact/artifacts2/phase3_scaling/compressed_parts_m5_opt"


AWS_CONFIG = {
    "ami_id": "ami-06c7c20c67513469a",  # Ubuntu 22.04 LTS
...
def run():
    ...
    log(f"Codec: {CODEC}, Threads: {THREADS}, Max workers: {MAX_WORKERS}")
...
if __name__ == "__main__":
    ...
    with open("m5_large_horizontal_opt.log", "w") as logfile:
